...
int getSensor(String sensorID) {
  if (sensorID == "FF") {
    return FF.readRangeSingleMillimeters()/10+Foffset;
  } else if (sensorID == "RF") {
    return RF.readRangeSingleMillimeters()/10+RFoffset;
  } else if (sensorID == "RB") {
    return RB.readRangeSingleMillimeters()/10+RBoffset;
  } else if (sensorID == "BB") {
